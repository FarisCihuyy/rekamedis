      ...
      <nav class="app-header navbar navbar-expand bg-body">
        ...
        <div class="container-fluid">
          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item d-none d-md-block"><a href="<?= base_url() ?>" class="nav-link">Website</a></li>
          </ul>
          ...
          <ul class="navbar-nav ms-auto">
              ...
              <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end">
                <a href="#" class="dropdown-item">
                  ...
                  <div class="d-flex">
                    <div class="flex-shrink-0">
                      <img
                        src="<?=base_url('assets/adminlte/assets/img/user1-128x128.jpg')?>"
                        alt="User Avatar"
                ...
                <a href="#" class="dropdown-item">
                  ...
                  <div class="d-flex">
                    <div class="flex-shrink-0">
                      <img
                        src="<?=base_url('assets/adminlte/assets/img/user8-128x128.jpg')?>"
                        alt="User Avatar"
                        class="img-size-50 rounded-circle me-3"
                      />
                    </div>
                ...
                <a href="#" class="dropdown-item">
                  ...
                  <div class="d-flex">
                    <div class="flex-shrink-0">
                      <img
                        src="<?=base_url('assets/adminlte/assets/img/user3-128x128.jpg')?>"
                        alt="User Avatar"
                        class="img-size-50 rounded-circle me-3"
                      />
                    </div>
            ...
            <li class="nav-item dropdown user-menu">
              <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                <img
                  src="<?=base_url('assets/adminlte/assets/img/user2-160x160.jpg')?>"
        ...
        <div class="sidebar-wrapper">
          <nav class="mt-2">
            ...
            >
              ...
              <li class="nav-item menu-open">
                <a href="<?=base_url('patient_form') ?> " class="nav-link active">
                    <i class="bi bi-plus-circle"></i>
                  <p>
                    Formulir Pasien
                  </p>
                      ...
                      <ul class="contacts-list">
                        ...
                        <li>
                          <a href="#">
                            <img
                              class="contacts-list-img"
                              src="<?=base_url('assets/adminlte/assets/img/user7-128x128.jpg')?>"
                              alt="User Avatar"
                            />
                            <div class="contacts-list-info">
                              <span class="contacts-list-name">
                        ...
                        <li>
                          <a href="#">
                            <img
                              class="contacts-list-img"
                              src="<?=base_url('assets/adminlte/assets/img/user5-128x128.jpg')?>"
                              alt="User Avatar"
                            />
                            <div class="contacts-list-info">
                              <span class="contacts-list-name">
                        ...
                        <li>
                          <a href="#">
                            <img
                              class="contacts-list-img"
                              src="<?=base_url('assets/adminlte/assets/img/user6-128x128.jpg')?>"
                              alt="User Avatar"
                            />
                            <div class="contacts-list-info">
                              <span class="contacts-list-name">
